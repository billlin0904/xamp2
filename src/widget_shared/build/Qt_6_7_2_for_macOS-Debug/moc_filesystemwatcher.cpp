...
constexpr auto qt_meta_stringdata_CLASSFileSystemWatcherENDCLASS = QtMocHelpers::stringData(
    "FileSystemWatcher",
    "directoryChanged",
    "",
    "onDirectoryChanged",
...
void FileSystemWatcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &FileSystemWatcher::directoryChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileSystemWatcher::directoryChanged(const QString & _t1)
{
