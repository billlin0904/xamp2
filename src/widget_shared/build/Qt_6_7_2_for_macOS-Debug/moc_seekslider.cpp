...
constexpr auto qt_meta_stringdata_CLASSSeekSliderENDCLASS = QtMocHelpers::stringData(
    "SeekSlider",
    "leftButtonValueChanged",
    "",
    "int64_t",
    "value"
);
...
void SeekSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->leftButtonValueChanged((*reinterpret_cast< std::add_pointer_t<int64_t>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SeekSlider::*)(int64_t );
            if (_t _q_method = &SeekSlider::leftButtonValueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SeekSlider::leftButtonValueChanged(int64_t _t1)
{
