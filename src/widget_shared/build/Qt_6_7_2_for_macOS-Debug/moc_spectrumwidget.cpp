...
struct qt_meta_stringdata_CLASSSpectrumWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSpectrumWidgetENDCLASS = QtMocHelpers::stringData(
    "SpectrumWidget",
    "onFftResultChanged",
    "",
    "ComplexValarray",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSpectrumWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SpectrumWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSpectrumWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSpectrumWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSpectrumWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SpectrumWidget, std::true_type>,
        // method 'onFftResultChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const ComplexValarray &, std::false_type>,
...
void SpectrumWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onFftResultChanged((*reinterpret_cast< std::add_pointer_t<ComplexValarray>>(_a[1]))); break;
...
void *SpectrumWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSpectrumWidgetENDCLASS.stringdata0))
