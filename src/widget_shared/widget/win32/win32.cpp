...
class XAMP_WIDGET_SHARED_EXPORT User32Lib {
public:
	User32Lib() 
...
class XAMP_WIDGET_SHARED_EXPORT DwmapiLib {
public:
	DwmapiLib()
...
class XAMP_WIDGET_SHARED_EXPORT UxThemeLib {
public:
...
enum class XAMP_WIDGET_SHARED_EXPORT BorderlessWindowStyle : DWORD {
