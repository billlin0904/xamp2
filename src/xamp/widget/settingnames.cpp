...
const ConstLatin1String kAppSettingBottomColor{ "AppSettings/theme/bottomColor" };
const ConstLatin1String kAppSettingAlphaColor{ "AppSettings/theme/alphaColor" };
