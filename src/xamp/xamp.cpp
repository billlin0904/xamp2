...
void Xamp::initialPlaylist() {
    ...
    //setting_page_.reset(new CardView(tr("Settings")));
    //yt_music_tab_page_->hide();
    ...
    //ui_.naviBar->addTab(translateText("Settings"), TAB_SETTING, qTheme.fontIcon(Glyphs::ICON_SETTINGS));
