...
/*
 *
 * fftwf_plan_guru64_split_dft_r2c - FFTW3 wrapper to Intel(R) oneAPI Math Kernel Library (Intel(R) oneMKL).
 *
 ******************************************************************************
 */
...
{
    /*  Intel oneMKL DFTI doesn't support real to split complex */
    UNUSED(rank);
    UNUSED(dims);
    UNUSED(howmany_rank);
    UNUSED(howmany_dims);
