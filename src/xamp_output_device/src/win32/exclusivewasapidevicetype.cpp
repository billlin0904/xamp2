...
std::unique_ptr<Device> ExclusiveWasapiDeviceType::MakeDevice(const std::wstring& device_id) {
	return std::make_unique<ExclusiveWasapiDevice>(GetDeviceById(device_id));
}
